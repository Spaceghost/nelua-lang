...
s=s.replace('Native peer HTTP shootout','Luau / workerd HTTP shootout')
s=once(s,'LuaJIT metered | LuaJIT trusted | workerd → native','Native Luau | Luau/Wasm | workerd → Luau')
s=s.replace('actual JIT traces are required before timing.','Luau native code generation is not enabled in this lane.')
